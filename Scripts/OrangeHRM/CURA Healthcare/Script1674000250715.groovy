...
WebUI.setText(findTestObject('CURA Healthcare/Page_CURA Healthcare Service/input_Username_username'), 'John Doe')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/CURA Healthcare/Page_CURA Healthcare Service/select_Tokyo CURA Healthcare Center        _5b4107'), 
...
WebUI.click(findTestObject('Object Repository/CURA Healthcare/Page_CURA Healthcare Service/input_Medicaid_programs'))

WebUI.click(findTestObject('Object Repository/CURA Healthcare/Page_CURA Healthcare Service/div_Visit Date (Required)_input-group-addon'))

WebUI.click(findTestObject('Object Repository/CURA Healthcare/Page_CURA Healthcare Service/td_18'))
